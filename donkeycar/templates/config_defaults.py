...
# CAMERA
# CAMERA_TYPE = "PICAM"   # (PICAM|WEBCAM|CVCAM|STRUCTURE_CAM)
CAMERA_TYPE = "STRUCTURE_CAM"  # (PICAM|WEBCAM|CVCAM|STRUCTURE_CAM)
IMAGE_W = 320
IMAGE_H = 240
IMAGE_DEPTH = 2  # default RGB=3, make 1 for mono
