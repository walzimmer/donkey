...
class KerasCategorical(KerasPilot):
    ...
    def __init__(self, input_shape=(240, 320, 2), *args, **kwargs):
...
class KerasLinear(KerasPilot):
    ...
    def __init__(self, num_outputs=2, input_shape=(240, 320, 2), *args, **kwargs):
...
class KerasIMU(KerasPilot):
    ...
    def __init__(self, model=None, num_outputs=2, num_imu_inputs=6, input_shape=(240, 320, 2), *args, **kwargs):
...
class KerasBehavioral(KerasPilot):
    ...
    def __init__(self, model=None, num_outputs=2, num_behavior_inputs=2, input_shape=(240, 320, 2), *args, **kwargs):
...
class KerasLocalizer(KerasPilot):
    ...
    # def __init__(self, model=None, num_outputs=2, num_behavior_inputs=2, num_locations=8, input_shape=(120, 160, 3),
    def __init__(self, model=None, num_outputs=2, num_behavior_inputs=2, num_locations=8, input_shape=(240, 320, 2),
                 *args, **kwargs):
...
def default_categorical(input_shape=(240, 320, 2)):
...
class KerasRNN_LSTM(KerasPilot):
    ...
    def __init__(self, image_w=320, image_h=240, image_d=2, seq_length=3, num_outputs=2, *args, **kwargs):
...
def rnn_lstm(seq_length=3, num_outputs=2, image_shape=(240, 320, 2)):
    from keras.layers import Input, Dense
...
class Keras3D_CNN(KerasPilot):
    ...
    def __init__(self, image_w=320, image_h=240, image_d=2, seq_length=20, num_outputs=2, *args, **kwargs):
